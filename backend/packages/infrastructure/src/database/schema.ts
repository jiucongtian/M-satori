...
export const cardReadings = pgTable(
  'card_readings',
  {
    ...
    consumptionIntentId: uuid('consumption_intent_id'),
    consumptionAttempt: integer('consumption_attempt').notNull().default(1),
    seedQuantity: integer('seed_quantity'),
    seedCostRuleVersion: varchar('seed_cost_rule_version', { length: 64 }),
