...
export function DailyReport({ name, insight, energyLevel, balance, onBack, onNext }: { name: string; insight: DailyInsight | null; energyLevel?: EnergyLevel; balance: number | null; onBack: () => void; onNext: () => void }) {
