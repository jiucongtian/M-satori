...
export function DailyStart({ name, energyLevel, balance, onBack, onNext }: { name: string; energyLevel?: EnergyLevel; balance: number | null; onBack: () => void; onNext: () => void }) {
...
export function SeedPayment({ balance, busy, onBack, onNext, onSupport }: { balance: number | null; busy: boolean; onBack: () => void; onNext: () => void; onSupport: () => void }) {
