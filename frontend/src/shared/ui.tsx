...
export function Brand({ compact = false }: { compact?: boolean }) { return <Link className={`brand ${compact ? "brand-compact" : ""}`} href="/" aria-label="五福荟首页"><img className="brand-lockup" src="/brand/wufuhui-lockup.png" alt="五福荟 WU FU HUI" /></Link>; }
