...
const pageEvents: Array<{ matches: (pathname: string) => boolean; eventName: string; pageCode: string }> = [
  ...
  { matches: (path) => path === '/share/generating', eventName: 'share_poster_generation_viewed', pageCode: 'R1.1 · SHARE-02' },
  { matches: (path) => path === '/share/select', eventName: 'share_poster_selection_viewed', pageCode: 'R1.1 · SHARE-03' },
  { matches: (path) => path === '/share/preview', eventName: 'share_poster_preview_viewed', pageCode: 'R1.1 · SHARE-04' },
